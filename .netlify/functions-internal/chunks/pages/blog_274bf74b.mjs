...
async function getSrcset(
  ...
  const { default: load } = await import('../load_4e190cce.mjs');
...
let lookupMap = {};
lookupMap = {"posts":{"type":"content","entries":{"welcome-to-astro":"/src/content/posts/welcome-to-astro.mdx","crafting-digital-magic":"/src/content/posts/crafting-digital-magic.mdx","recommended-supps":"/src/content/posts/recommended-supps.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/crafting-digital-magic.mdx": () => import('../crafting-digital-magic_78a28cd2.mjs'),"/src/content/posts/recommended-supps.mdx": () => import('../recommended-supps_5e31a442.mjs'),"/src/content/posts/welcome-to-astro.mdx": () => import('../welcome-to-astro_40731be7.mjs')
